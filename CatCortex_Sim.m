...
x1 = round(25.5*num_neu/100);
x2 = round(25.5*num_neu/100);
x3 = round(12.2*num_neu/100);
x4 = round(12.2*num_neu/100);
neu_list(idx_neu_list(1:x1)) = 1;
neu_list(idx_neu_list(x1+1:x1+x2)) = 4;
neu_list(idx_neu_list(x1+x2+1:x1+x2+x3)) = 4;
neu_list(idx_neu_list(x1+x2+x3+1:x1+x2+x3+x4)) = 2;
neu_list(idx_neu_list(x1+x2+x3+x4+1:end)) = 3;
